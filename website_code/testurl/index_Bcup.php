...
mysql_query("delete from apsisrecordtest7  ");
...
function right($str, $length) {
 ...
 $query_for_paging2="select * FROM apsisrecordtest7  order by id desc";
...
var tableToExcel = (function() {
 ...
 <input type="submit" class="txtField" onClick="tableToExcel('example', '<?php echo date('Y-m-d')?>')" value="Export to Excel">
